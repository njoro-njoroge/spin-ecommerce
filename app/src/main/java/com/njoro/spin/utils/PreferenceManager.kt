...
open class PreferenceManager  constructor(context: Context) : IPreferenceHelper {
    ...
    override fun setFirstName(lastName: String) {
        preferences[FIRST_NAME] = lastName
    }
    ...
    override fun setPhoneNo(phoneNo: String) {
        preferences[PHONE_NO] = phoneNo
    }
    override fun getPhoneNo(): String {
        return preferences[PHONE_NO] ?: ""
    }
